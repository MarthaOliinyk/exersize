    ...
    return(
       <section  className="main__container why__container">
        ...
        <div className="why__right_part">
            ...
            <p className="why__text">Only good things are said about us. But it is better to see and feel 1 time than to read 10 times. We are working with the world-class equipment and proven-by-time specialists.</p>
        </div>
       </section>
    )
}
