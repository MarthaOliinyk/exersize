        ...
        <section className='benefit__wrapper'>
            <div className='main__container benefit__container'>
                <div className='benefit__left'>
                    ...
                    <p className='benefit__text'>Literally everyone. We are currently helping people from 12 to 60+
                        years old. Everyone is getting an adjusted program and a big variety of exercises.</p>
