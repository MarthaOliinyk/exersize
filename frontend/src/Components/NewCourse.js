        ...
        <section className='main__container addcourse__container'>
            ...
            <form className='form__addcourse'>
                ...
                <div className='form__field'>
                    ...
                    <textarea id='desc' required minLength={10} maxLength={2000} name='desc'
                ...
                <div className='form__field'>
                    ...
                    <input id='subs_name' required minLength={3} maxLength={45} className='form__input'
                           name="subs_name"></input>
                </div>
                <div className='form__field'>
                    <label htmlFor="classes_number" className='form__label'>Number of classes </label>
                    <input id='classes_number' required type={"number"} className='form__input'
                           name="classes_number"></input>
                </div>
                <div className='form__field'>
